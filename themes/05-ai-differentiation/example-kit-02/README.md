...
> Старт: [01_quick_start_A.md](01_quick_start_A.md).

---

## 🎯 Цель пакета
Формируется самодостаточный набор материалов для выполнения **обязательной части A (A-core)**: от входной проверки подготовки (diagnostic level check) до сравнения двух контуров моделей и итогового решения по качеству.
...
## 🧭 Маршрут работы
1. Пройти быстрый запуск в [01_quick_start_A.md](01_quick_start_A.md).
2. Выполнить входную проверку и назначить стартовый уровень по [02_inputs_and_level_assignment.md](02_inputs_and_level_assignment.md).
3. Взять чистовые шаблоны Таблиц 1–5 из [03_templates_tables_1_5.md](03_templates_tables_1_5.md).
4. Провести генерацию и доработку материалов по протоколу из [04_prompt_and_evaluation_protocol.md](04_prompt_and_evaluation_protocol.md).
5. Проверить комплект через критерии качества и состав сдачи в [05_submission_and_quality_gate.md](05_submission_and_quality_gate.md).
6. Сверить структуру с полностью заполненным сквозным примером в [06_example_report_A_complete.md](06_example_report_A_complete.md).

---

## 🧱 Что входит в полный комплект каждого уровня
Для каждого уровня `basic`, `standard`, `advanced` требуется создать:
